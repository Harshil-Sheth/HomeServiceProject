    ...
    <div id="faq" className="block faqBlock">
      <div className="container-fluid">
        ...
        <Collapse defaultActiveKey={['1']}>
          <Panel className="panel" header="How to setup the theme?" key="1">
          ...
          <Panel className="panel" header="Can I change plan or cancel at any time?" key="2">
          ...
          <Panel className="panel" header="How to access through cloud?" key="3">
          ...
          <Panel className="panel" header="Can I manage multiple task?" key="4">
          ...
          <Panel className="panel" header="How can I change my password?" key="5">
          ...
          <Panel className="panel" header="How to manage my account?" key="6">
